...
import Uploadbutton from '@/components/dropdown-upload'
...
import BulkImport from '@/my-library/pages/BulkImport'
import index from 'my-library/components/index'
import HomePage from 'my-library/components/index'
